...
if ($message == $json['buttons']['question-answer-dating вопросы для девушек'] && $cmddating[0] == '' && empty($cmd[0]) && $user_infodating['reg_status'] === 0) {

    $user_gender_question = $db->setGenderFilterQuestion($chatid, 2);
